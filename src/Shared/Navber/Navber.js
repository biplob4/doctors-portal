...
const Navber = () => {
    ...
    const manu = <>
        ...
        <li><Link className='font-bold' to='/contuct'>Contuct us</Link></li>
        <li>{user ? <button onClick={() => signOut(auth)} className='btn btn-ghost font-bold'>Sign  out</button> : <Link className='font-bold' to='/login'>Login</Link>}</li>
    </>
    return (
